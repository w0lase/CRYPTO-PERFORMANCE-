...
COMBINED_eth <- combined_data_eth_2018_2019+combined_data_eth_2020_2021+combined_data_eth_2022_2023

rownames(COMBINED_eth) <- c("Negative","Positive")

COMBINED_RF_eth <- COMBINED_eth/312
...
pgf_fixed(COMBINED_RF_eth)  


six_years_totals_eth <- cross_tab_with_totals_eth_2018_2019+cross_tab_with_totals_eth_2020_2021+cross_tab_with_totals_eth_2022_2023
