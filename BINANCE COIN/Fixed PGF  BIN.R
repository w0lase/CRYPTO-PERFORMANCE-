...
COMBINED_bin <- combined_data_bin_2018_2019+combined_data_bin_2020_2021+combined_data_bin_2022_2023

rownames(COMBINED_bin) <- c("Negative","Positive")

COMBINED_RF_bin <- COMBINED_bin/312
...
pgf_fixed(COMBINED_RF_bin)  


six_years_totals_bin <- cross_tab_with_totals_bin_2018_2019+cross_tab_with_totals_bin_2020_2021+cross_tab_with_totals_bin_2022_2023
